...
class Trainer(object):
    ...
    def train_step(self, data):
        ...
        #loss = self.objective(z1, z2) + (reconstruction_loss(r1, x1) + reconstruction_loss(r2, x2)) * 0.001
        loss = (reconstruction_loss(r1, x1) + reconstruction_loss(r2, x2))
...
# model
#model = DeepCCA([784, 50, 10], [784, 50, 10])
...
trainer = Trainer('DCCAE_pretrain', model, objective, optimizer=optimizer, lr_scheduler=None, use_checkpoint='scratch')
#trainer = Trainer('DCCAE', model, objective, optimizer=optimizer, use_checkpoint='./workspace/checkpoints/DCCAE_pretrain_best.pth.tar', resume=False)
#trainer = Trainer('DCCAE', model, objective, optimizer=optimizer, use_checkpoint='scratch')
